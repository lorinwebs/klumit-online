...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      <nav className="w-full px-4 py-3 md:px-6 md:py-4 grid grid-cols-[auto_1fr_auto] md:grid-cols-[auto_1fr_auto] items-center gap-4 h-14 md:h-auto">
        
        {/* שמאל במובייל - מועדון לקוחות */}
        <div className="flex items-center justify-start h-full order-1 md:order-3">
          {/* תפריט דסקטופ */}
          ...
          <Link
            ...
            className="md:hidden text-xs font-light tracking-wide uppercase text-[#1a1a1a] hover:text-[#25D366] transition-colors whitespace-nowrap relative z-10 flex items-center gap-1.5"
        ...
        {/* מרכז - לוגו */}
        <Link href="/" className="flex items-center justify-center h-full text-2xl luxury-font font-light tracking-luxury text-[#1a1a1a] shrink-0 order-2 md:order-1">
          Klumit
        </Link>
        
        {/* ימין במובייל / ימין בדסקטופ - אייקונים */}
        <div className="flex items-center gap-3 md:gap-4 shrink-0 h-full order-3 md:order-1">
          <UserMenu />
